    ...
    <div className="container mx-auto px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-900 rounded-lg border border-gray-700 p-6 mb-8 font-mono">
          <div className="text-accent-teal mb-4">{">"} contact ./nikuhacks</div>
          <div className="text-gray-300 ml-4">
            ={">"} [
            <a
              href="https://github.com/Nikesh-Uprety"
              className="text-accent-teal hover:underline mx-2"
              target="_blank"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              I'm always interested in discussing cybersecurity projects, CTF
              challenges, or opportunities to build secure applications. Feel
              free to reach out!
            </p>
